  ...
  try {
    ...
    const allDispatches = await db
      .select({
        ...
        patientReference: dispatchRequests.patientReference,
        ambulanceId: dispatchRequests.ambulanceId,
        dispatcherSessionId: dispatchRequests.dispatcherSessionId,
        bedCategoryCode: dispatchRequests.bedCategoryCode,
        requestedBeds: dispatchRequests.requestedBeds,
        approvedBeds: dispatchRequests.approvedBeds,
        reviewRequired: dispatchRequests.reviewRequired,
        reviewReason: dispatchRequests.reviewReason,
        rejectionReason: dispatchRequests.rejectionReason,
